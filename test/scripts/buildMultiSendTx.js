...
const MULTISENDJSON = require("../../../frontend/artifacts/contracts/marketplace/Multisend.sol/MultiSend.json");
...
const buildMultiSendTx = (
  ...
  const multiSendInterface = new ethers.utils.Interface(MULTISENDJSON.abi);
  const erc721Interface = new ethers.utils.Interface(ERC721JSON.abi);
